...
build_info.BUILD_DISPLAY_VERSION       = "7.1";
build_info.BUILD_DISPLAY_VERSION_SHORT = "7.1";

build_info.ZIP_FILES_PREFIX            = "netbeans-7.1-201112071828-ml";
build_info.BUNDLE_FILES_PREFIX         = "netbeans-7.1-ml";
build_info.BOUNCER_PRODUCT_PREFIX      = "netbeans-7.1-ml";

build_info.COMMUNITY_BUILD             = "0";
build_info.SHOW_ADDITIONAL_LANGUAGES   = "1";

build_info.ADDITIONAL_BUILD_LOCATION   = "http://bits.netbeans.org/netbeans/7.1/community/latest/";

build_info.BUILD_LOCATION = "http://download.netbeans.org/netbeans/7.1/final/";
...
build_info.add_download_tabs = function() {
	add_download_tab("7.0.1", "https://netbeans.org/downloads/7.0.1/");
