...
var JDK_NOTE_ALL = "O Java 6 \u00e9 necess\u00e1rio para instalar e executar o PHP e C/C++ NetBeans embutido. Voc\u00ea pode baixar a <a href=\"{0}\">\u00faltima vers\u00e3o do Java em java.com</a>.<br><br>O JDK 6 \u00e9 necess\u00e1rio para instalar e executar o Java SE, Java EE e todos os componentes do Netbeans. Voc\u00ea pode baixar o <a href=\"{1}\">JDK independente</a> ou a \u00faltima vers\u00e3o do <a href=\"{2}\">JDK com o NetBeans IDE Java SE embutido</a>.<br><br>";
//var JDK_NOTE_MACOSX   = "JDK 5.0 is required for installing and running the NetBeans IDE.";
var JDK_NOTE_MACOSX = "O Java 6 é necessário para instalar e executar os conjuntos do NetBeans, PHP e C/C++.<br><br>O JDK 6 é necessário para instalar e executar o Java SE, Java EE e todos os conjuntos do NetBeans.<br><br>Caso precise do Java 6 ou do JDK 6, a Apple fornece sua própria versão do Java. Use o recurso Atualizar software (disponível no menu Apple) para verificar se você tem a versão mais atualizada do Java para seu Mac";
