...
var JDK_NOTE_MACOSX   = "Java 6 is required for installing and running the PHP and C/C++ NetBeans Bundles.<br><br>JDK 6 is required for installing and running the Java SE, Java EE and All NetBeans Bundles. <br/><br>If you need Java 6 or JDK 6, Apple supplies their own version of Java. Use the Software Update feature (available on the Apple menu) to check that you have the most up-to-date version of Java for your Mac.";
