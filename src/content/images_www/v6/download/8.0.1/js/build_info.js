...
build_info.BUILD_DISPLAY_VERSION       = "8.0.1";
build_info.BUILD_DISPLAY_VERSION_SHORT = "8.0.1";

build_info.ZIP_FILES_PREFIX            = "netbeans-8.0.1-201408251540";
build_info.BUNDLE_FILES_PREFIX         = "netbeans-8.0.1";
build_info.BOUNCER_PRODUCT_PREFIX      = "netbeans-8.0.1";

build_info.COMMUNITY_BUILD             = "0";
build_info.SHOW_ADDITIONAL_LANGUAGES   = "1";

build_info.ADDITIONAL_BUILD_LOCATION   = "/images_www/v6/download/community/8.0.1/";

build_info.BUILD_LOCATION = "http://download.netbeans.org/netbeans/8.0.1/final/";
...
build_info.add_download_tabs = function() {
	add_download_tab("8.0", "//netbeans.org/downloads/8.0");
