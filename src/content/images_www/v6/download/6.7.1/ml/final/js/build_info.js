...
build_info.BUILD_DISPLAY_VERSION       = "6.7.1";
build_info.BUILD_DISPLAY_VERSION_SHORT = "6.7.1";

build_info.ZIP_FILES_PREFIX            = "netbeans-6.7.1-200911211148-ml";
build_info.BUNDLE_FILES_PREFIX         = "netbeans-6.7.1-ml";
build_info.BOUNCER_PRODUCT_PREFIX      = "netbeans-6.7.1-ml";

build_info.COMMUNITY_BUILD             = "0";
build_info.SHOW_ADDITIONAL_LANGUAGES   = "1";

build_info.ADDITIONAL_BUILD_LOCATION   = "http://bits.netbeans.org/netbeans/6.7.1/community/fcs.new/";

build_info.BUILD_LOCATION = "http://download.netbeans.org/netbeans/6.7.1/final/";
