...
build_info.BUILD_DISPLAY_VERSION       = "6.9.1";
build_info.BUILD_DISPLAY_VERSION_SHORT = "6.9.1";

build_info.ZIP_FILES_PREFIX            = "netbeans-6.9.1-201007282301-ml";
build_info.BUNDLE_FILES_PREFIX         = "netbeans-6.9.1-ml";
build_info.BOUNCER_PRODUCT_PREFIX      = "netbeans-6.9.1-ml";

build_info.COMMUNITY_BUILD             = "0";
build_info.SHOW_ADDITIONAL_LANGUAGES   = "1";

build_info.ADDITIONAL_BUILD_LOCATION   = "http://bits.netbeans.org/netbeans/6.9.1/community/final/";

build_info.BUILD_LOCATION = "http://download.netbeans.org/netbeans/6.9.1/final/";
...
build_info.add_download_tabs = function() {
	...
	add_download_tab("7.0", "https://netbeans.org/downloads/7.0/");
