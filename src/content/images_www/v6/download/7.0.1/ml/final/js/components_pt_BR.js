...
add_product_info(
                 ...
                 "",
                 "O GlassFish Server Open Source Edition 3.1.1 é a versão mais recente do GlassFish Application Server, é uma implementação compatível da plataforma Java EE 6 e apresenta uma arquitetura modular, leve e extensível.",
                 48113,
                 "windows, linux, solaris-sparc, solaris-x86, macosx-ppc, macosx-x86");
