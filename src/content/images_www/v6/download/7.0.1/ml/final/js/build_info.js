...
build_info.BUILD_DISPLAY_VERSION       = "7.0.1";
build_info.BUILD_DISPLAY_VERSION_SHORT = "7.0.1";

build_info.ZIP_FILES_PREFIX            = "netbeans-7.0.1-201107282000-ml";
build_info.BUNDLE_FILES_PREFIX         = "netbeans-7.0.1-ml";
build_info.BOUNCER_PRODUCT_PREFIX      = "netbeans-7.0.1-ml";

build_info.COMMUNITY_BUILD             = "0";
build_info.SHOW_ADDITIONAL_LANGUAGES   = "1";

build_info.ADDITIONAL_BUILD_LOCATION   = "http://bits.netbeans.org/7.0.1/community/latest/";

build_info.BUILD_LOCATION = "http://download.netbeans.org/netbeans/7.0.1/final/";
...
build_info.add_download_tabs = function() {
	add_download_tab("6.9.1","/downloads/6.9.1/");
