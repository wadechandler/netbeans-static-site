...
build_info.BUILD_DISPLAY_VERSION       = "6.8";
build_info.BUILD_DISPLAY_VERSION_SHORT = "6.8";

build_info.ZIP_FILES_PREFIX            = "netbeans-6.8-200912041610-ml";
build_info.BUNDLE_FILES_PREFIX         = "netbeans-6.8-ml";
build_info.BOUNCER_PRODUCT_PREFIX      = "netbeans-6.8-ml";

build_info.COMMUNITY_BUILD             = "0";
build_info.SHOW_ADDITIONAL_LANGUAGES   = "1";

build_info.ADDITIONAL_BUILD_LOCATION   = "http://bits.netbeans.org/netbeans/6.8/community/fcs/";

build_info.BUILD_LOCATION = "http://download.netbeans.org/netbeans/6.8/final/";
...
build_info.add_download_tabs = function() {
	add_download_tab("6.8");
    add_download_tab("6.9", "https://netbeans.org/downloads/6.9/");
