...
build_info.BUILD_DISPLAY_VERSION       = "6.7";
build_info.BUILD_DISPLAY_VERSION_SHORT = "6.7";

build_info.ZIP_FILES_PREFIX            = "netbeans-6.7-200906241340-ml";
build_info.BUNDLE_FILES_PREFIX         = "netbeans-6.7-ml";
build_info.BOUNCER_PRODUCT_PREFIX      = "netbeans-6.7-ml";

build_info.COMMUNITY_BUILD             = "0";
build_info.SHOW_ADDITIONAL_LANGUAGES   = "1";

build_info.ADDITIONAL_BUILD_LOCATION   = "http://bits.netbeans.org/netbeans/6.7/community/fcs/";

build_info.BUILD_LOCATION = "http://download.netbeans.org/netbeans/6.7/final/"; 

build_info.LOAD_OMNITURE_CODE          = 1;
build_info.LOAD_GOOGLE_ANALYTICS_CODE  = 0;
build_info.USE_BOUNCER                 = 0;
build_info.ADD_VERSION_INFO_TO_URL     = 1;
...
build_info.add_download_tabs = function() {
	...
	add_download_tab("6.8", "https://netbeans.org/downloads/6.8/");
	add_download_tab("JavaFX", "https://netbeans.org/downloads/6.5.1");
