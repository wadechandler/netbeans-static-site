...
build_info.BUILD_DISPLAY_VERSION       = "8.1";
build_info.BUILD_DISPLAY_VERSION_SHORT = "8.1";

build_info.ZIP_FILES_PREFIX            = "netbeans-8.1-201510222201";
build_info.BUNDLE_FILES_PREFIX         = "netbeans-8.1";
build_info.BOUNCER_PRODUCT_PREFIX      = "netbeans-8.1";

build_info.COMMUNITY_BUILD             = "0";
build_info.SHOW_ADDITIONAL_LANGUAGES   = "1";

build_info.ADDITIONAL_BUILD_LOCATION   = "/images_www/v6/download/community/8.1/";

build_info.BUILD_LOCATION = "http://download.netbeans.org/netbeans/8.1/final/";
...
build_info.add_download_tabs = function() {
	add_download_tab("8.0.2", "/downloads/8.0.2/");
	add_download_tab("8.1");
	add_download_tab("8.2", "/downloads/");
	add_download_tab(DEVELOPMENT_TITLE,DEVELOPMENT_BUILDS_LINK);
	add_download_tab('JDK9 Branch', 'http://bits.netbeans.org/netbeans/nb9-for-jdk9_jigsaw/daily/latest/');
