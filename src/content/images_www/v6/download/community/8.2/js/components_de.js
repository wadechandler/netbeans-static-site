...
add_product_info(
                 ...
                 "",
                 "GlassFish Server 4.1.1 provides a server for the development and deployment of Java Platform Enterprise Edition (Java EE) and dynamic, scalable HTML5 applications. Key features include Java EE 7 compatibility, modularity, and rapid iterative development.",
                 50721,
                 "windows, linux, solaris-sparc, solaris-x86, macosx-ppc, macosx-x86");
...
add_product_info(
                 ...
                 "HTML5/JavaScript",
                 "",
                 "Tools for developing HTML5 web applications, Node.js applications and Cordova applications, both on the desktop, as well as with iOS and Android devices. Includes HTML5/Javascript application project type, page inspector and visual CSS style editor, editors for HTML, JavaScript, CSS, SASS and LESS, and a JavaScript debugger.",
                 7781,
                 "windows, linux, solaris-sparc, solaris-x86, macosx-ppc, macosx-x86");
