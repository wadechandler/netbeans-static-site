...
add_product_info(
                 ...
                 "Java SE",
                 "",
                 "使用 Java 進行程式設計的基本工具，包括編輯器、除錯程式、效能分析工具、重構支援工具以及獲獎的拖放式 GUI 設計工具 (先前稱為 Project Matisse)。",
                 31723,
                 "windows, linux, solaris-sparc, solaris-x86, macosx-ppc, macosx-x86");
...
add_product_info(
                 ...
                 "",
                 "GlassFish v3 為 GlassFish Application Server 的下一個主要版本，目前由 GlassFish 社群開發。GlassFish v3 具有模組化、簡易且可延伸的架構。",
                 56835,
                 "windows, linux, solaris-sparc, solaris-x86, macosx-ppc, macosx-x86");
...
add_product_info(
                 ...
                 "",
                 "符合 Java Servlet 和 JSP 規格的開放原始碼 Web 容器。",
                 4513,
                 "windows, linux, solaris-sparc, solaris-x86, macosx-ppc, macosx-x86");
...
add_product_info(
                 ...
                 "Java Web 和 EE",
                 "",
                 "用於建立相容於 J2EE 1.4 和 Java EE 5 規格的 Java Web 及企業應用程式的工具。包括對 Servlet、JSP、標籤程式庫、Spring、Struts、Java Persistence API、Enterprise Java Beans、JAX-WS 和 RESTful Web 服務，以及 Java Server Faces、Groovy 語言和 Grails 框架等的支援。提供視覺化拖放式應用程式開發環境。",
                 39433,
                 "windows, linux, solaris-sparc, solaris-x86, macosx-ppc, macosx-x86");
...
add_product_info(
                 ...
                 "Java ME",
                 "",
                 "用於建立行動電話及可攜式裝置使用的 Java Micro Edition 應用程式之完整工具集。包括視覺化設計程式、Web 服務連線精靈，以及處理裝置分段程序問題的工具。",
                 2259,
                 "windows, linux");
...
add_product_info(
                 ...
                 "C/C++",
                 "",
                 "用於開發 C 和 C++ 應用程式的工具。包括專案範本、現有專案支援、進階編輯器、除錯支援，以及用於配置管理的 makefile 精靈。",
                 5217,
                 "windows, linux, solaris-sparc, solaris-x86, macosx-ppc, macosx-x86");
...
add_product_info(
                 ...
                 "PHP",
                 "",
                 "用於開發 PHP 應用程式的工具，包括 PHP 編輯器和除錯程式、專案管理、與 Apache 伺服器整合、支援 MySQL 和其他資料庫、FTP 上傳和下載、JavaScript 支援以及其他功能。",
                 2737,
                 "windows, linux, solaris-sparc, solaris-x86, macosx-ppc, macosx-x86");
